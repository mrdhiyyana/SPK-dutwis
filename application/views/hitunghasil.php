            ...
            <table width="100%" >
                <tr>
                    <td>
                        <h5 style="text-align:center">
                            PERIODE <?=date('Y/m/d',strtotime($period->tgl_mulai)).' s/d '.date('Y/m/d',strtotime($period->tgl_selesai)).' , '.$period->keterangan?>
                            <br>
                            <br>
                            <br>
                        </h5>
                ...
                <tr>
                    <td style="text-align:justify">
                        Sistem Pendukung Keputusan Seleksi Calon Duta Wisata Kota Pekalongan dengan Menggunakan Metode TOPSIS ini sebagai alat bantu pengambilan keputusan. Berdasarkan perhitungan metode TOPSIS, sistem merekomendasikan nama berikut :
                        <br><br>
                    </td>
                </tr>
                <tr>
