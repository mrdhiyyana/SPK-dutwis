                            ...
                            <div class="col-sm-10">
                                <select name="id_tahun" id="per" class="form-control" required>
                                    ...
                                    <option value="<?= $key->id_tahun ?>" selected>
                                        <?php
                                        echo date("Y/m/d", strtotime($key->tgl_mulai)) . '-' . date("Y/m/d", strtotime($key->tgl_selesai)) . ' , ' . $key->keterangan;
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $key->ketkri ?></td>
                                            <td><input type="number" class="form-control" min="10" max="100" name="<?= $key->name ?>" placeholder="Nilai minimal 10 maksimal 100" required></td>
                                        </tr>
                                        <?php
